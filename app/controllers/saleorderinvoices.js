...
async function ImprimirPdf(req, res) {
    ...
    if (facturas.Customer.TypeofTaxpayer === "ConsumidorFinal") {   //para consumidor final
        ...
        console.log("id de la compañia: " + req.params.companyId);
        ...
        //imprimiendo para validar que se esten tomando coordendas
        ...
        doc
            ...
            // .text(facturas.Customer.Address, coordenadasfiscal.addressCoorX, coordenadasfiscal.addressCoorY)
            ...
            // .text(facturas.Customer.City, coordenadasfiscal.cityCoorX, coordenadasfiscal.cityCoorY)
        ...
        //creando condicion en el caso que no exista coordenada
        if (coordenadasfiscal.codInvoiceCoorX != 0 && coordenadasfiscal.codInvoiceCoorY != 0) {
            doc.text(facturas.CodInvoice, coordenadasfiscal.codInvoiceCoorX, coordenadasfiscal.codInvoiceCoorY)
        }

        if (coordenadasfiscal.cityCoorX != 0 && coordenadasfiscal.cityCoorY != 0) {
            doc.text(facturas.Customer.City, coordenadasfiscal.cityCoorX, coordenadasfiscal.cityCoorY)
        }

        if (coordenadasfiscal.addressCoorY != 0 && coordenadasfiscal.addressCoorX != 0) {
            doc.text(facturas.Customer.Address, coordenadasfiscal.addressCoorX, coordenadasfiscal.addressCoorY)
        }

        if (coordenadasfiscal.ncrCoorX != 0 && coordenadasfiscal.ncrCoorY != 0) {
            doc.text(facturas.Customer.Ncr, coordenadasfiscal.ncrCoorX, coordenadasfiscal.ncrCoorY)
        }

        if (coordenadasfiscal.sectorNameCoorX != 0 && coordenadasfiscal.sectorNameCoorX != 0) {
            doc.text(facturas.Customer.Sector.Name, coordenadasfiscal.sectorNameCoorX, coordenadasfiscal.sectorNameCoorY)
        }
        //fin de condicion de la coordenda
