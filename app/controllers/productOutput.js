...
async function createProductOutput(req, res) {
    ...
    ProductOuput.ConceptEntryExit = conceptId;
...
async function createProductOutputsinInvoice(req, res) {
    ...
    //agregue el ConceptEntryExit para recibir el id del concepto
    const { User, SaleInvoiceId, Company, Customer, InvoiceNumber, Comments, ConceptEntryExit } = req.body;
    let outputDataDetail = [];
    ...
    ProductOuput.ConceptEntryExit = ConceptEntryExit;
...
async function viewProductOutputDetails(req, res) {
    ...
    productOutputDetail.find({ ProductOutput: saleId }).populate({
